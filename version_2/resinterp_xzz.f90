Program Main
  ...
  integer ( kind = 4 ), parameter :: ny = 130
  ...
  u_filename = 'u_00036000.res'
  u_filename_out = 'u_00036000_in.res'

  v_filename = 'v_00036000.res'
  v_filename_out = 'v_00036000_in.res'

  w_filename = 'w_00036000.res'
  w_filename_out = 'w_00036000_in.res'

  p_filename = 'p_00036000.res'
  p_filename_out = 'p_00036000_in.res'

  d_filename = 'densp_00090002.res'
  d_filename_out = 'densp_00090002_in.res'
