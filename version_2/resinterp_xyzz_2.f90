Program Main
  ...
  integer ( kind = 4 ), parameter :: nz = 642 
  ...
  u_filename = 'u_00030000.res'
  u_filename_out = 'u_00030000_in.res'

  v_filename = 'v_00030000.res'
  v_filename_out = 'v_00030000_in.res'

  w_filename = 'w_00030000.res'
  w_filename_out = 'w_00030000_in.res'

  p_filename = 'p_00030000.res'
  p_filename_out = 'p_00030000_in.res'

  d_filename = 'densp_00024000.res'
  d_filename_out = 'densp_00024000_in.res'


   write(*,*) 'Original restartfile size: nx=',nx,' ny=',ny,' nz=',nz
   write(*,*) 'Interpolated restartfile size: nx=',nxi2,' ny=',nyi1,' nzi2=',nzi2
...
!   do  k=2,nz-1 !skipping the first (even number of points: this loop does not reach the last gc) 
!      di4(:,:,2*k-1)=0.75*di3(:,:,k)+0.25*di3(:,:,k+1)
!   enddo


!   do  k=2,nz-1  !skipping the last gc (even number of points) 
