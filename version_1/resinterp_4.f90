Program Main
  ...
  u_filename_out = 'u_00030000_in_zz.res'

  v_filename = 'v_00030000.res'
  v_filename_out = 'v_00030000_in_zz.res'

  w_filename = 'w_00030000.res'
  w_filename_out = 'w_00030000_in_zz.res'

  p_filename = 'p_00030000.res'
  p_filename_out = 'p_00030000_in_zz.res'

  d_filename = 'dens_00030000.res'
  d_filename_out = 'dens_00030000_in_zz_new.res'


   write(*,*) 'Original restartfile size: nx=',nx,' ny=',ny,' nz=',nz
   write(*,*) 'Interpolated restartfile size: nx=',nxi2,' ny=',nyi2,' nzi2=',nz
